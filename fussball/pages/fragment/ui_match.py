...
def render_match_from_id(match_id: str, con: Session, redirect: Callable):
    ...
    render_match(match_details, player_ratings, redirect)

def render_match(match_details: MatchDetails, player_ratings: list[PlayerRatingInfo], redirect: Callable):
